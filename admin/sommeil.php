        ...
        <table>
            ...
            <tbody>
                ...
                foreach ($rows as $row) {
                    ...
                    echo "<td><a href='edit_sommeil.php?id=" . $row['id_sommeil'] . "'>Modifier</a> | <a onclick=\"return confirm('Êtes-vous sûr de vouloir supprimer cet enregistrement ?')\" href='delete_sommeil.php?id=" . $row['id_sommeil'] . "'>Supprimer</a></td>";
                    echo "</tr>";
                }
                ?>
            </tbody>
